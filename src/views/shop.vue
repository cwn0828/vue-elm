 <template>
    <div>
                ...
                <section class="description_header">
                    ...
                    <footer class="description_footer" v-if="shopDetailData.activities.length" @click="showActivitiesFun">
                        <p class="ellipsis">
                            ...
                            <span style="margin-left:0.15rem">{{shopDetailData.activities[0].description}}（APP专享）</span>
                        </p>
                    ...
                    <section class="activities_list">
                        ...
                        <ul>
                            <li v-for="item in shopDetailData.activities" :key="item.id">
                                ...
                                <span style="margin-left:0.15rem">{{item.description}}（APP专享）</span>
                            </li>
                        </ul>
                    </section>
       ...
       <section class="animation_opactiy shop_back_svg_container" v-if="showLoading">
           <img src="../assets/shop_back_svg.svg">
       </section>
...
<style lang="scss" scoped>
    ...
    .shop_detail_header{
        ...
        .description_header{
            ...
            padding: 1.7rem 0 0.4rem 0.4rem;
            width: 100%;
            overflow: hidden;
            .description_top{
                display: flex;
