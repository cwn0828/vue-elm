 <template>
  <div class="page">
    <firstHeader head-title="推荐有奖" go-back="true"></firstHeader>
    <section class="activity_banner">
      <img src="../assets/activity.png" />
    </section>
    <section class="invite_firend">
      <div class="invite_firend_style">
        <img src="../assets/weixin.png" @click="fenxiang" />
        <p>邀请微信好友</p>
      </div>
      <div class="invite_firend_style">
        <img src="../assets/qq.png" @click="fenxiang" />
        <p>邀请QQ好友</p>
      </div>
      <div class="invite_firend_style">
        <img src="../assets/fenxiang.png" @click="fenxiang" />
        <p>面对面邀请</p>
      </div>
    </section>
