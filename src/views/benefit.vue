 <template>
  <div class="rating_page">
    <firstHeader head-title="我的优惠" go-back="true"></firstHeader>
      ...
      <transition name="router-fade">
        <section v-if="categoryType === 1">
          <section class="hongbao_container">
            <header class="hongbao_title">
              <section class="total_number">
                有
                <span>{{hongbaoList.length}}</span> 个红包即将到期
              </section>
              <section class="hongbao_description">
                <img src="../assets/description.png" height="24" width="24" />
          ...
          <footer class="hongbao_footer">
            ...
            >兑换红包</router-link>
            <router-link to="/benefit/commend" class="hongbao_style">推荐有奖</router-link>
          </footer>
        </section>
      </transition>
      <transition name="router-fade">
        <section v-if="categoryType === 2" class="voucher_container">
          ...
          <section class="unable_use">
            <img src="../assets/voucher.png" height="170" width="300" />
            <p>无法使用代金券</p>
            <p>非客户端或客户端版本过低</p>
