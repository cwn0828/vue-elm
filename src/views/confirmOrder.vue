<template>
  <div class="confirmOrderContainer">
    <section v-if="!showLoading">
      <firstHeader head-title="确认订单" goBack="true" signin-up="confirmOrder"></firstHeader>
      ...
      <section class="food_list">
        <header>
          <img src="//elm.cangdu.org/img/16cc2b82e9b51810.png" />
          <span>这是我修改的</span>
        </header>
        <ul class="food_list_ul">
          <li class="food_item_style">
            <p class="food_name ellipsis">1231</p>
            <div class="num_price">
              <span>x 1</span>
              <span>¥20</span>
            </div>
        ...
        <div class="food_item_style total_price">
          <p class="food_name ellipsis">订单 ¥241</p>
          <div class="num_price">
            <span>待支付 ¥200</span>
          </div>
        </div>
      ...
      <section class="pay_way container_style">
        <router-link to="/confirmOrder/remark" class="header_style">
          <span>订单备注</span>
          <div class="more_type">
        ...
        <router-link to="/confirmOrder/invoice" class="hongbo support_is_available">
          <span>发票抬头</span>
          <span>
            不需要开发票
            <svg class="address_empty_right">
