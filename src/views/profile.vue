<template>
  <div class="profile_page">
    <firstHeader go-back="true" :head-title="profiletitle"></firstHeader>
    <section>
      ...
      <section class="profile-1reTe">
        ...
        <router-link to="/order" class="myorder">
          <aside>
            <svg fill="#4aa5f0">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#order" />
            </svg>
          </aside>
        ...
        <a href="https://home.m.duiba.com.cn/#/chome/index" class="myorder">
          <aside>
            <svg fill="#fc7b53">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#point" />
            </svg>
          </aside>
          <div class="myorder-div">
            <span>积分商城</span>
        ...
        <router-link to="/vipcard" class="myorder">
          <aside>
            <svg fill="#ffc636">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#vip" />
            </svg>
          </aside>
          <div class="myorder-div">
            <span>饿了么会员卡</span>
      ...
      <section class="profile-1reTe">
        ...
        <router-link to="/service" class="myorder">
          <aside>
            <svg fill="#4aa5f0">
              <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#service" />
            </svg>
          </aside>
          <div class="myorder-div">
            <span>服务中心</span>
